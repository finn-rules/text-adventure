...
public class TextAdventure {
    String oseraName = "The mysterious, lumbering figure."; 
    ...
    // For these functions : we can add a parameter for Osera's distance, which would be the effective "difference" between
    // the player and Osera. Remember, player can move rooms, but Osera needs the player to "wait" a turn to move.
    public static String hallway1Description() {
        return ("You look around the hallway. To your right, you see a whiteboard, with what looks like writing on it as well as "
                +
                "a terrifying, horror looking drawing and some discourse about the ethics of using AI generated art. This might be worth reading. To your left there is an odd plant, "
                +
    ...
    public static String hallway2Description() {
        return ("You look around this hallway. To your right, you see a door with a locked code on it. Through the window you can see many computers.\n "
                +
                "Their screens are frozen... literally. Covered in ice! What a strange sight.\n" 
                +
    ...
    public static String hallway3Description() {
        return ("You look around this hallway. To your left, you can see the cs commons, this door does not appear to need a code to get in."
                +
                "Further down the hallway, it is still dark, but you start to see a human looking figure with a bald head.");
    }
    ...
    public static String hallway4Description() {
        return ("You look around this hallway. To your right, you can see a locked door that needs a code for entry, " +
                "You can start to see the human figure now, he appears to be wearing a blue raincoat, shorts, and sandals.");
    }
    ...
    public static String hallway5Description() {
        return ("The figure is right in front of you now! It is Professor Osera, and he looks upset! He yells at you that you must become a computer science major "
                +
                "and turn in your declaration now! He starts to run at you, and just behind him you can see the stairs to leave this frightening floor. "
                +
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int waitStatus = 0;
        Player player = new Player(20, new String[] { "bandage", "dull pencil" });
        NPC osera = new NPC("Professor Osera", 100, new String[] { "exit key" }, 
        "This mysterious figure is finally clear to you. He's an angry professor, wearing a blue raincoat," +
        " shorts, and sandals.\n You can see his bald head glistening in the faint light of the hallway.\n" +
        "One thing is for sure, he's angry. And he's pacing the hallway, looking for you.");
        ...
        hallway1 = new hallway1(null, new Room[] { null, null, hallway2, null }, hallway1Description(), waitStatus, new Obstacle[] {},
                null);
        hallway2 = new hallway2(null, new Room[] { null, thirty_eight_thirteen, hallway3, hallway1 }, hallway2Description(),
                waitStatus, new Obstacle[] {}, null);
        hallway3 = new hallway3(null, new Room[] { commons, null, hallway4, hallway2 }, hallway3Description(), waitStatus,
                new Obstacle[] {}, null);
        hallway4 = new hallway4(null, new Room[] { hallway3, thirty_eight_eighteen, hallway5 }, hallway4Description(),
                waitStatus, new Obstacle[] {}, null);
        hallway5 = new hallway5(null, new Room[] { hallway4 }, hallway5Description(), waitStatus, new Obstacle[] {},
                null);
        commons = new commons(null, new Room[] { null, hallway3, null, null }, commonsDescription(), waitStatus, new Obstacle[] {}, null);
        thirty_eight_thirteen = new thirty_eight_thirteen(null, new Room[] { hallway2 }, thirteenDescription(),
                waitStatus, new Obstacle[] {}, null);
        thirty_eight_eighteen = new thirty_eight_eightteen(null, new Room[] { hallway4 }, eighteenDescription(),
                waitStatus, new Obstacle[] {}, null);
