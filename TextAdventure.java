...
public class TextAdventure {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        hallway1 = new hallway1(null, new Room[]{hallway2, null, null, null}, hallway1Description(), waitStatus, new Obstacle[]{}, null);
        hallway2 = new hallway2(null, new Room[]{hallway3, hallway1, thirty_eight_thirteen, null}, hallway2Description(), waitStatus, new Obstacle[]{}, null);
        hallway3 = new hallway3(null, new Room[]{hallway4, hallway2, commons, null}, hallway3Description(), waitStatus, new Obstacle[]{}, null);
        hallway4 = new hallway4(null, new Room[]{hallway5, hallway3, thirty_eight_eighteen, null}, hallway4Description(), waitStatus, new Obstacle[]{}, null);
        hallway5 = new hallway5(null, new Room[]{null, hallway4, null, null}, hallway5Description(), waitStatus, new Obstacle[]{}, null);
        commons = new commons(null, new Room[]{null, null, hallway3, null}, commonsDescription(), waitStatus, new Obstacle[]{}, null);
